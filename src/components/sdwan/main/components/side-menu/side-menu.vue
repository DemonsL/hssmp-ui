...
export default {
  ...
  computed: {
    textColor () {
      return this.theme === 'light' ? '#333' : '#495060'
    }
  },
  watch: {
    activeName (name) {
...
.ivu-layout-sider{border-right:solid 5px #F0F0F0;}
.search-con{padding:8px;border-bottom:solid 1px #F0F0F0;}
.search-con .ivu-input{border-radius:0;}
.search-con .ivu-input {
    background:#FFF;
