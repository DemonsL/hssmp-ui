...
.ivu-tree-arrow{display:inline-block;width:21px;}
.ivu-tree-arrow i{width:21px;height:18px;font-family: Ionicons;line-height:16px;}
.ivu-tree-arrow i::after{display:inline-block;content:"\F11F";}
</style>