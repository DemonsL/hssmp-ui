...
export function getDate (time1, time2) {
  ...
  let data = {};
  //计算出相差天数
  data.timeDay = Math.floor(date3/(24*3600))
  //计算出小时数
  var leave1=date3%(24*3600)  //计算天数后剩余的毫秒数
  data.timeHour = Math.floor(leave1/(3600))
  //计算相差分钟数
  var leave2=leave1%(3600)    //计算小时数后剩余的毫秒数
  data.timeMinutes = Math.floor(leave2/(60))
  //计算相差秒数
  var leave3=leave2%(60)   //计算分钟数后剩余的毫秒数
  data.timeseconds = Math.round(leave3)
  return data;
}
